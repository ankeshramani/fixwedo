		 			...
		 			<div className="chat-inner">
		 				<div className="accepted-box-bg m-b-0">
		                    ...
		                    <div className="bottom-two-btn">
		                    	...
		                    	<a className="bottom-two-box" href="/#">Added Additional Work <i className="fa fa-check" aria-hidden="true"></i></a>
		                    </div>
...
export default OffersAddedExtra;