                ...
                <div className="chat-main-box">
                    <div className="chat-inner">
                        <div className="accepted-box-bg m-b-0">
                            <div className="accepted-box-body">
                                ...
                                <div className="right-img">
                                    ...
                                    <h5>Green Bay Services</h5>
                                </div>
                            </div>
                            <div className="bottom-two-btn private-confirm-msg confirmation-box">
                                <a className="bottom-two-box mt-0" href="/#">Accepted <i className="fa fa-check" aria-hidden="true"></i></a>
                        ...
                        <div className="row m-b-0 received-chat">
                            <div className="col">
                                <div className="msg m-b-20">
                                    <p>Lorem ipsum dolor sit amet, consectetur adi iscing elit, sed do eiusmod tempor incidiunt ut labore et dolore magna aliqua. Lorem ipsum dolor sit amet, consectetur adi iscing elit, sed do eiusmod tempor incidiunt ut labore
                        ...
                        <div className="row m-b-0 send-chat">
                            <div className="col">
                                <div className="msg m-b-20">
                                    <p>Lorem ipsum dolor sit amet, consectetur adi iscing elit, sed do eiusmod tempor incidiunt ut labore et dolore magna aliqua. consectetur adi iscing elit, sed do eiusmod tempor incidiunt ut. onsectetur adi iscing elit, sed
                                    do eiusmod tempor.</p>
                                </div>
