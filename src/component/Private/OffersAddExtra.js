		 			...
		 			<div className="chat-inner">
	                    ...
	                    <div className="row m-b-0 received-chat">
	                        <div className="col">
	                            <div className="msg m-b-20">
	                                <p>Lorem ipsum dolor sit amet, consectetur adi iscing elit, sed do eiusmod tempor incidiunt ut labore et dolore magna aliqua. </p>
	                            </div>
	                    ...
	                    <div className="offerbox-main">
		                    ...
		                    <div className="private-offer-btn">
		                    	<a className="reject-btn" href="/#">Reject</a>
		                    	<a href="/#">Accept</a>
		                    </div>
		                    <div className="offer-chat-private">
		                    	<p>Lorem ipsum dolor sit amet, consectetur adi iscing elit, sed do eiusmod tempor incidiunt ut labore et dolore magna aliqua. Ipsum dolor sit amet, consectetur adi iscing elit, sed do eiusmod tempor incidiunt ut labore et dolore magna aliqua. </p>
		                    </div>
		                </div>
		 			</div>
